...
export default function EmployeeAttendanceSheet() {
  ...
  return (
    <div className="text-gray-600 w-full flex justify-center max-h-[80vh] mt-12 overflow-y-auto">
      <div className="w-full max-w-[96vw]  2xl:max-w-[90vw] border-b border-gray-300">
          ...
          <tbody>
            {data.map((i, index) => (
              <tr key={index} className="border-t hover:bg-green-200 cursor-pointer">
                <td className="px-1 lg:px-2 py-2 text-center border border-gray-300 text-xs">{i.code}</td>
